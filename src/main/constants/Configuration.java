...
/**
 * Nessa classe estão todas as constantes de configuração do sistema.
 * Por aqui é mais fácil alterar os valores que serão usados no jogo.
 */
public class Configuration {
    ...
    public static final String BACKGROUND_IMAGE = "https://c.tenor.com/-HHhdrE8K-8AAAAC/stars.gif";

    public static final int ITEM_SPEED = 12;
    public static final int SPIDER_ID = 1;
    public static final int DOUBLE_SHOT_ID = 2;
}
